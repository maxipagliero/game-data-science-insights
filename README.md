...
> Status: Work in progress – projects are being developed and refined over time.
...
- Relational databases / data warehouses (e.g. PostgreSQL, BigQuery-like setups)
...
- KPI & metric design (ARPU, retention, funnels, suspiciousness scores, etc.)
- Supervised learning for classification (e.g. cheater vs. non-cheater)
- Experimentation and A/B test analysis (simulated)
